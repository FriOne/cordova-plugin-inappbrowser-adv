...
# cordova-plugin-inappbrowser-adv

This plugin is copy of cordova-plugin-inappbrowser plugin. I added "intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);"
to allow using fileURIs to external apps. And one more thing <framework src="com.android.support:support-v4:23.4.0" />.
